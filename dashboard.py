...
app.layout = html.Div([
    html.Div(children=[
        html.H1('First Dashboard', style={'color':'blue', 'text-align':'center','margin':'5px','padding':'5px'})
        ...
        dcc.Graph(id='Scatter Plot',
                  figure={'data':[go.Scatter(x=data['pop'],
                          ...
                          'layout':go.Layout(title='Scatter Plot',
                                             xaxis={'title':'Pop'},
                                             yaxis={'title':'gdp/cap'})})
    ],style={'border':'1px black solid', 'float':'left','width':'50%', 'height':'490px'}),
    html.Div(children=[
        dcc.Graph(id='Bar Plot',
                  figure={'data':[go.Bar(x=data['year'],
                          ...
                          'layout':go.Layout(title='Bar Plot',
                                             xaxis={'title':'Year'},
                                             yaxis={'title':'Pop'})})
    ],style={'border':'1px black solid', 'float':'left','width':'49.70%', 'height':'490px'}),
html.Div(children=[
